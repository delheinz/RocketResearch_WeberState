...
This process may be done in Command Prompt, Microsoft VS Code, or any terminal of choice. *(Note: If using VS Code, ensure the terminal is opened to Command Prompt and not Powershell.)*
...
* To activate the venv enter "venv\scripts\activate"

### Runing the App
"streamlit run dataprocessor.py"

---
 -- End of README_Windows --
